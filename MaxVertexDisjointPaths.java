 ...
 * Это позволяет учесть ограничение на использование вершины только в одном пути. Для исходных вершин S и T устанавливается бесконечная пропускная способность.
 *
 * Для нахождения максимального потока используется алгоритм Диница, эффективный для сетей с единичными пропускными способностями.
 */
